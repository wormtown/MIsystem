					...
					<ul class="nav" id="side-menu">
						...
						<li>
							...
							<ul class="nav nav-second-level collapse">
								...
								<li>
									<a href="${pageContext.request.contextPath}/CommnowMi/qiandu/newSearch.do">传声千度</a>
								</li>
							</ul>
						</li>
						<li>
						...
						<li>
							<a href="${pageContext.request.contextPath}/CommnowMi/brief/index.do"><i class="fa fa-home nav_icon"></i>简报系统</a>
						</li>
						<li>
						...
						<div class="forms">
							<div class="form-grids row widget-shadow" data-example-id="basic-forms"> 
								...
								<div class="form-body" id="form-div">
									<form id="brief" action="briefing.do" method="get">
										 <div style="margin-bottom:20px;">	
											 <div class="col-md-4 form-group"> 
											  	<label for="exampleInputPassword1">时间</label> 
											  	<input type="date" class="form-control" name="date" id="start"/> 
											 </div> 
											 <div class="col-md-4 form-group">
											 	 <label for="selector1">公司</label>
												 <select name="company" id="selector1" class="form-control">
													 <option>陶氏</option>
													 <option>鑫达</option>
												 </select>
											 </div>
											 <div class="col-md-4 form-group">
											 	 <label for="selector1">回溯</label>
												 <select name="days" id="selector1" class="form-control">
										 ...
										 <div style="text-align:right">
										 	<button type="submit" class="btn btn-default" style="margin-right:1rem" id="preview">提交</button> 
										 </div>	
									</form> 
