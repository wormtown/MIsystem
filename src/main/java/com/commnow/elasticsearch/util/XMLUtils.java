...
public class XMLUtils {
	public final static String CONFIG_PATH = Thread.currentThread().getContextClassLoader().getResource("/").getPath(); 
	...
	public static List<String> readText(Element element){
	...
	public static Element getElements(String path, String nodeName) throws Exception{
	   //创建saxReader对象  
	...
	public static void test(String path, String nodeName) throws Exception{
		 //创建saxReader对象  
	       SAXReader reader = new SAXReader();  
	       //通过read方法读取一个文件 转换成Document对象  
	       Document document = reader.read(new File(path));  
   ...
   public static void main(String[] args) throws Exception {
		Element element = XMLUtils.getElements("src/main/resources/schedule.arguments.xml", "companys");
